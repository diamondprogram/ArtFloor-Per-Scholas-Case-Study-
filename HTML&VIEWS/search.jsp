...
<html>
    ...
    <body>
        ...
        <nav class="topnav">
        	<a class = "nav-button"href="${pageContext.request.contextPath}/home" >Home</a>
        ...
        <div class = "container">
            <div class = "row">
                <div class="col-sm-12" id = "row1_body_div">
                    <div class="tab">
                       <h4 style = "color:white; padding-right: 10px;"> Results for ${word}</h4>
                      </div>
                        ...
                        <div id = "searchbody">
							<c:forEach var="posts" items="${keyword}">
